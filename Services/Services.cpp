...
int main(int argc, char* argv[])
{
	...
	addrlisten.sin_port = htons(PORT_NUM);
	...
	while (TRUE)
	{
		...
		else
		{
			...
			CALL_EVENTPROC(Service,szBuf,aSock[nIndex - WSA_WAIT_EVENT_0]);
